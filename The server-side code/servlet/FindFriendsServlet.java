...
import com.active.school.biz.impl.ShowfriendsBizImpl;
...
public class FindFriendsServlet extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		IShowfriendsBiz showfriensBiz = new ShowfriendsBizImpl();
		List<Friends> lstfriends =  showfriensBiz.FindFriends(userid);
		for (Friends friend:lstfriends){
			friend.toString();
		}
		Gson gson = new GsonBuilder().setDateFormat("yyyy-MM-dd hh:mm:ss").create();
		String gson_data = gson.toJson( lstfriends);
